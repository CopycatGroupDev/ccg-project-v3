...
export default function BoutiquesMenu() {
    return <Layout {...animation}>
        <div>
            <BoutiqueCard to={"/boutiques/sevres"} color={colors.sevres} img={"/icons/shop_pink.PNG"} {...infos.sevres} />
            <BoutiqueCard to={"/boutiques/boulogne"} color={colors.boulogne} img={"/icons/shop_orange.PNG"} {...infos.boulogne} />
        </div>
        <div>
