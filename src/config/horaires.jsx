export const horaires = {
    Sèvres: [
      { col: 1, color: '#0061ad', jour: 'Lundi', debut: ['9H'], fin: ['18H30'] },
      ...
      { col: 2, color: '#0061ad', jour: 'Samedi', debut: ['9H', '13H30'], fin: ['12H30', '17H30'] },
    ...
    Boulogne: [
      ...
      { col: 2, color: '#0061ad', jour: 'Samedi', debut: ['10H30'], fin: ['17H'] },
      { col: 2, color: '#0aa13c', jour: 'Dimanche', debut: null, fin: null }
    ]
}